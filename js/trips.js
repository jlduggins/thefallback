...
const Trips = {
  ...
  openAddLegModal(journeyId, preselectedDestId=null) {
    ...
    document.getElementById('leg-modal').classList.add('show');
  },
  ...
  closeLegModal() { document.getElementById('leg-modal').classList.remove('show'); this.returnToLegModalAfterSave=false; this.legModalInitialState=null; },
  ...
  async editLeg(journeyId, legIndex) {
    ...
    this.storeLegModalInitialState(); document.getElementById('leg-modal').classList.add('show');
  },
  ...
  closeMapsModal(){document.getElementById('maps-modal').classList.remove('show');},
  ...
  selectMapsDestination(destId){this.pendingMapsAction={type:'navigate',destId};this.closeMapsModal();document.getElementById('maps-picker-modal').classList.add('show');},
  shareFullRoute(){this.pendingMapsAction={type:'share'};this.closeMapsModal();document.getElementById('maps-picker-modal').classList.add('show');},
  closeMapsPickerModal(){document.getElementById('maps-picker-modal').classList.remove('show');this.pendingMapsAction=null;},
