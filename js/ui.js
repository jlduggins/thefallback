...
const UI = {
  ...
  _drawerIds: ['locations-panel', 'trips-list-panel', 'location-detail-panel', 'explore-backup-panel', 'discover-detail-panel', 'modal-discover', 'explore-left-drawer', 'modal-add-location'],
